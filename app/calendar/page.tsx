...
//     mockDividendStocks.forEach((stock) => {
//       const shares = investment / mockDividendStocks.length / stock.price;
//       const dripShares = stock.dripEligible ? shares + (shares * stock.yield / 4) : shares;
...
import { mockDividendStocks, DividendStock } from '@/utils/mockDividendStocks';
